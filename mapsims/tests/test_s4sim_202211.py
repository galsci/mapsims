...
def test_s4sim_202222_ame_high():
    ...
    output_map = hp.read_map("cmbs4_ame_high_uKCMB_LAT-LFL1_nside64_0000.fits", (0,1,2))

    expected_map = hp.read_map("mapsims/tests/data/cmbs4_ame_high_uKCMB_LAT-LFL1_nside64_0000.fits.gz", (0,1,2))
