...
PACKAGENAME = metadata.get("package_name", "mapsims")
DESCRIPTION = metadata.get("description", "Map based simulations package")
AUTHOR = metadata.get("author", "Simons Observatory Collaboration")
AUTHOR_EMAIL = metadata.get("author_email", "")
LICENSE = metadata.get("license", "unknown")
URL = metadata.get("url", "https://github.com/simonsobs/mapsims")
...
if sys.version_info < tuple(
    ...
    sys.stderr.write(
        "ERROR: mapsims requires Python {} or later\n".format(
...
package_info["package_data"][PACKAGENAME].append("example_config.toml")
